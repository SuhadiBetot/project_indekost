                                                ...
                                                <a href="app-profile.html" class="dropdown-item ai-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                            ...
                                                            <!-- Replace the path with the edit icon path -->
                                                            <path d="M12,2 C6.4771525,2 2,6.4771525 2,12 C2,17.5228475 6.4771525,22 12,22 C17.5228475,22 22,17.5228475 22,12 C22,6.4771525 17.5228475,2 12,2 Z M12,20 C7.581722,20 4,16.418278 4,12 C4,7.581722 7.581722,4 12,4 C16.418278,4 20,7.581722 20,12 C20,16.418278 16.418278,20 12,20 Z M11,6 L13,6 L13,12.5857864 L8.70710678,16.8786797 L7.29289322,15.4644661 L11,11.7573593 L11,6 Z" fill="var(--primary)" fill-rule="nonzero"/>
                                                        </g>
                                                    </svg>
                                                    <span class="ms-2 text-primary">Edit </span>
                                                </a>
                                            </div>
