            ...
            <div class="card p-3">
                <div class="row">
                    <div class="col-xl-8 text-black">
                        <img src="{{ asset('ownerkos/' . $ownerDataKosts->foto_depan) }}" class="w-100"
                            alt="foto depan">
                    ...
                    <div class="col-xl-4">
                        <img src="{{ asset('ownerkos/' . $ownerDataKosts->foto_dalam) }}" alt=""
                            class="w-100">
                        @php
                    ...
                    <div class="justify-content-end d-flex gap-3">
                        <a href="{{ route('app-admin') }}" class="btn text-white fw-bold"
                            style="background-color: #C91919;">Kembali</a>
                        @if ($ownerDataKosts->status == 'belum diterima')
                            <form action="{{ route('app-admin-update', $ownerDataKosts) }}" method="post">
                                @csrf
                                <input type="text" name="status" value="sudah diterima" hidden>
                                <button type="submit" class="btn text-white fw-bold"
                                    style="background-color: #3D5EE1;">Setuju</button>
                            </form>
                        @endif
                    </div>
                </div>
