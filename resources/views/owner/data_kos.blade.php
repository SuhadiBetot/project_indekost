                                            ...
                                            @if (auth()->user()->id == $data->user_id)
                                                @if ($data->status == 'sudah diterima')
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img class="rounded-circle" width="50" height="50"
                                                                src="{{ asset('ownerkos/' . $data->foto_depan) }}"
                                                                alt="">
                                                            <img class="rounded-circle" width="50" height="50"
                                                                src="{{ asset('ownerkos/' . $data->foto_dalam) }}"
                                                                alt="">
                                                        </td>
                                                        <td>
                                                            <div class="d-flex">
                                                                <a href="#"
                                                                    ...
                                                                    data-bs-target="#exampleModal{{ $data->id }}"><i
                                                    ...
                                                    <div class="modal fade text-black"
                                                        id="exampleModal{{ $data->id }}" tabindex="-1"
                                                                ...
                                                                <div class="modal-body row">
                                                                    <div class="col-xl-12">
                                                                        <div class="row text-break">
                                                                            ...
                                                                            <span
                                                                                class="col-xl-9">:{{ $data->ketentuan }}</span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-xl-12">
                                                                        <div class="row text-break">
                                                                            ...
                                                                            <span
                                                                                class="col-xl-9">:{{ $data->lokasi }}</span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-xl-12">
                                                                        <div class="row">
                                                                            ...
                                                                            <span
                                                                                class="col-xl-9">:{{ 'Rp.' . number_format($data->harga, 0, ',', '.') }}</span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-xl-12">
                                                                        <div class="row">
                                                                            ...
                                                                            :<img
                                                                                src="{{ 'ownerkos/' . $data->foto_depan }}"
                                                                                alt="" class="mb-3">
                                                                            <img src="{{ 'ownerkos/' . $data->foto_dalam }}"
                                                                                alt="">
                                                                        </div>
                                                                    </div>
                                                                </div>
