  ...
  <div class="card-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-md text-end">
            <a href="{{ route('landing', ['id' => $user->id]) }}" class="btn btn-secondary btn-sm" style="border-radius:100px; height:40px; width:100px; font-size:16px; font-weight:700;">
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24">
                        <path fill="currentColor" d="m12 3l11 8.25l-1.2 1.6L20 11.5V21H4v-9.5l-1.8 1.35l-1.2-1.6zm-4.65 9.05q0 1.325 1.425 2.825T12 18q1.8-1.625 3.225-3.125t1.425-2.825q0-1.1-.75-1.825T14.1 9.5q-.65 0-1.188.263T12 10.45q-.375-.425-.937-.687T9.9 9.5q-1.05 0-1.8.725t-.75 1.825"/>
                    </svg>
                </span>
                Beranda
            </a>
...
<br>
    ...
    <br>
    <form method="POST" action="{{ route('edit.profile', ['id' => $user->id]) }}" enctype="multipart/form-data">
      @csrf
      @method('PUT')
      <div class="card-hero">
        ...
        @if (Auth::user()->foto == null)
          <div class="default-photo-container">
            <img src="{{ asset('asset/images/default/default.png') }}" class="img-fluid rounded-circle"
              alt="" />
          </div>
        @else
          <div class="default-photo-container">
